...
@section('content')
    <div
        class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 flex flex-col">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center group">
                        <div class="relative">
                            <img src="{{ asset('logo-kanboard.png') }}" alt="kanboard-logo"
                                class="h-16 w-auto object-cover transition-transform duration-300 group-hover:scale-110">
                            <div
                        ...
                        <span
                            class="ml-4 text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Kanboard</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center p-4">
            <div class="w-full max-w-md">
                <div class="text-center mb-8">
                    <div
                        class="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl">
                ...
                <div
                    class="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('password')"
                                    ...
                                    <i class="fas fa-eye text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('password_confirmation')"
                                    class="absolute inset-y-0 right-0 pr-4 flex items-center">
                                    <i class="fas fa-eye text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                                        id="password-confirmation-toggle"></i>
                                </button>
                            </div>
                        ...
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center">
                ...
                <div
                    class="mt-8 bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl rounded-2xl p-6 border border-white/20 dark:border-gray-700/50">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 text-center">Pourquoi choisir Kanboard?
                    </h3>
                    <div class="space-y-3">
                        <div class="flex items-center">
                            <div
                        ...
                        <div class="flex items-center">
                            <div
                                class="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mr-3">
                                <i class="fas fa-check text-white text-sm"></i>
                            </div>
        ...
        <footer
            class="flex-shrink-0 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl border-t border-white/20 dark:border-gray-700/50 py-8">
