        ...
        <form action="{{ route('tableau.create') }}" method="POST" class="p-8">
            ...
            <div class="flex items-center mb-8">
                ...
                <button type="button" onclick="closeCreateProjectModal()"
                    class="ml-auto text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200">
            ...
            <div class="space-y-6">
                <div class="space-y-2">
                    <label for="table-name" class="text-sm font-medium text-gray-700 dark:text-gray-300">Nom du
                        projet</label>
                    <div class="relative">
                ...
                <div class="space-y-2">
                    <label for="table-description"
                        class="text-sm font-medium text-gray-700 dark:text-gray-300">Description (optionnel)</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-align-left text-gray-400"></i>
                        </div>
                        <textarea id="table-description" name="description" rows="3"
