    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full">
                ...
                <div class="hidden lg:flex space-x-1 ms-6 xl:ms-10">
                    ...
                    @if(Auth::user() && Auth::user()->hasRole('admin'))
                        <a href="{{ route('users.index') }}"
                            class="px-3 xl:px-4 py-2 rounded-xl text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200 font-medium text-sm xl:text-base">
                            <i class="fas fa-user-shield mr-2"></i>Gestion des utilisateurs
                        </a>
                    @endif
                </div>
            </div>
        ...
        <div :class="{ 'block': open, 'hidden': !open }"
            ...
            <div class="px-4 py-6 space-y-4">
                ...
                @if(Auth::user() && Auth::user()->hasRole('admin'))
                    <a href="{{ route('users.index') }}"
                        class="w-full flex items-center px-4 py-3 rounded-xl text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all duration-200">
