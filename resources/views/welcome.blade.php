...
@section('content')
    <div
        class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
        ...
        <div class="relative overflow-hidden py-20 lg:py-32">
            ...
            <div
                class="absolute top-0 left-0 w-72 h-72 bg-blue-400/20 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2">
            </div>
            <div
                class="absolute top-0 right-0 w-72 h-72 bg-purple-400/20 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2">
            </div>
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-20 lg:pt-32 lg:pb-32">
                <div class="text-center">
                    ...
                    <p
                        class="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 lg:mb-16 max-w-4xl mx-auto animate-fade-in-delay">
                    ...
                    <div
                        class="flex flex-col sm:flex-row gap-6 lg:gap-8 justify-center items-center mb-20 lg:mb-32 animate-fade-in-delay-2">
                        <a href="{{ route('register') }}"
                            class="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center">
                            <i class="fas fa-rocket mr-3"></i>
                            Commencer gratuitement
                        </a>
                        <a href="#features"
                            class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl text-gray-700 dark:text-gray-300 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white dark:hover:bg-gray-800 transition-all duration-200 shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-700 flex items-center">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20 max-w-4xl mx-auto animate-fade-in-delay-3">
                        ...
                        <div class="text-center">
                            <div
                                class="text-3xl font-bold bg-gradient-to-r from-pink-600 to-red-600 bg-clip-text text-transparent">
                                99%</div>
        ...
        <div id="features" class="py-32 lg:py-48 bg-white/50 dark:bg-gray-900/50 backdrop-blur-xl">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
                    <div
                        class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-white/20 dark:border-gray-700/50">
                        <div
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            Organisez vos tâches en colonnes visuelles. Glissez-déposez pour une gestion fluide et intuitive
                            de vos projets.
                        </p>
                    </div>
                    ...
                    <div
                        class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-white/20 dark:border-gray-700/50">
                        <div
                            class="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mb-6">
                            <i class="fas fa-users text-white text-2xl"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Collaboration en Temps Réel</h3>
                        <p class="text-gray-600 dark:text-gray-300">
                            Travaillez en équipe avec des mises à jour instantanées. Partagez des commentaires et assignez
                            des tâches facilement.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            Visualisez l'avancement de vos projets avec des graphiques et des métriques détaillées pour
                    ...
                    <div
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            Accédez à vos projets depuis n'importe quel appareil. Interface optimisée pour mobile, tablette
                            et desktop.
                        </p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-gray-600 dark:text-gray-300">
                            Vos données sont protégées avec les dernières technologies de sécurité. Sauvegarde automatique
                            et chiffrement.
                        </p>
                    </div>
                    ...
                    <div
                        class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border border-white/20 dark:border-gray-700/50">
                        <div
                            class="w-16 h-16 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center mb-6">
                            <i class="fas fa-bolt text-white text-2xl"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-4">Performance Optimisée</h3>
                        <p class="text-gray-600 dark:text-gray-300">
                            Interface ultra-rapide avec des temps de chargement optimisés. Profitez d'une expérience fluide
                            et réactive.
                        </p>
                    </div>
                </div>
        ...
        <div class="py-32 lg:py-48 bg-gradient-to-r from-blue-600 to-purple-600">
            <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex flex-col sm:flex-row gap-6 lg:gap-8 justify-center">
                    <a href="{{ route('register') }}"
                        class="bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center justify-center">
                        <i class="fas fa-rocket mr-3"></i>
                        Commencer maintenant
                    </a>
                    <a href="{{ route('login') }}"
                        class="bg-transparent text-white border-2 border-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-blue-600 transition-all duration-200 flex items-center justify-center">
